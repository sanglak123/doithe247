    ...
    return (
        <div id="banks">
            <div className="bgr_white mt-2 banks_content">
                ...
                {addBank ? (
                    <Button
                        className="btn_addBanks"
                        variant="outline-danger"
                        onClick={() => setAddBanks(false)}
                    >
            ...
            <div className="bgr_white banks_content mt-2">
                ...
                {addReceiveBank ? (
                    <Button
                        className="btn_addBanks"
                        variant="outline-danger"
                        onClick={() => setAddReceiveBanks(false)}
                    >
                        <i class="fa fa-minus"></i>
                    </Button>
                ) : (
                    <Button
                        className="btn_addBanks"
                        variant="outline-primary"
                        onClick={() => setAddReceiveBanks(true)}
                    >
                        <i className="fa fa-plus"></i>
                    </Button>
                )}
