...
function AdminPrices({axiosJwt, accessToken}) {
        ...
        <div id="prices" className="">
            <div className="price_content bgr_white mt-2">
                ...
                <div className="table_change_cards">
                    <Tabs>
                        <TabList>
                            <Tab onClick={() => setCardRender("VIETTEL")}>
                                Cards Phone
                            </Tab>
                            <Tab onClick={() => setCardRender("ZING")}>
                                Cards Game
                            </Tab>
                        </TabList>
                        ...
                        <TabPanel>
                            <div className="card_item">
                                <div className="card_hearder">
                                    {PhoneCards?.map((card, index) => {
                                        return (
                                            <Button
                                                onClick={() =>
                                                    setCardRender(card.telco)
                                                }
                                                variant={
                                                    cardRender === card.telco
                                                        ? "danger"
                                                        : "success"
                                                }
                                                key={index}
                                ...
                                <div className="table_card_render">
                                    <TableCardsRender telco={cardRender} />
                                </div>
                            </div>
                        </TabPanel>
            ...
            <Button onClick={handleUpdatePrice} className="btn_update_prices">
                Update FeesChange
            </Button>
        </div>
    )
