                    ...
                    <tr>
                        ...
                        {PriceRender?.map((price, index) => {
                            return (
                                <th
                                    key={index}
                                    className="txt_center text_light txt_white"
                                >
                                    {formatMoney2(price.Value.name)}
                                </th>
                            )
                        })}
                    </tr>
                    ...
                    <tr>
                        ...
                        {PriceRender?.map((price, index) => {
                            return (
                                <th
                                    key={index}
                                    className="txt_center txt_white txt_light"
                                >
                                    {price.feesChange} %
                                </th>
                            )
                    ...
                    <tr>
                        ...
                        {PriceRender?.map((price, index) => {
                            return (
                                ...
                                >
                                    {edit ===
                                    `${price.telco}_${price.Value?.name}` ? (
                                        <InputGroup>
                                            <Form.Control
                                                type="number"
                                                step={0.1}
