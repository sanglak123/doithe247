...
import {SockeContext} from "../../config/socketInit"
...
function Refills(props) {
    ...
    const hadleCreateRefill = async () => {
        if (AccessToken) {
            await UserPaymentsApi.Refills.Create(
                AccessToken,
                dispatch,
                User?.id,
                amount,
            ...
            await UserPaymentsApi.Refills.GetAll(
                AccessToken,
                dispatch,
                User.id,
                UpdateRefillSuccess
                ...
                <div className="refill_content bgr_dark">
                    <div className="refill_item">
                        <div className="refill_hearder">
                            ...
                            <ul>
                                <li>
                                    - Nạp quỹ bằng tài khoản ngân hàng của
                                    bạn.Lợi dụng tính năng để RỬA TIỀN, NẠP XONG
                                    RÚT, KHÔNG NẠP CHÍNH CHỦ sẽ bị khóa vĩnh
                                    viễn, không hoàn số dư . Thời gian đợi thanh
                                    toán đối đa 15 phút.
                                </li>
                                <li>
                                    1. Chỉ cho phép Nạp tiền bằng ATM/MOMO của
                                    chính bạn để mua bán card, chuyển tiền, giao
                                    dịch hợp pháp
                                </li>
                                <li>
                                    2. Lấy ATM/MOMO của người khác nạp tiền vào
                                    web sẽ bị khóa vĩnh viễn, tịch thu tiền
                                </li>
                                <li>
                                    3. Nghiêm cấm nạp ATM xong rút Momo hoặc nạp
                                    Momo xong rút ATM
                                </li>
                                <li>
                                    4. Thời gian đợi thanh toán đối đa 15 phút.
                                    Hệ thống tự động cộng tiền 24/24. Vui lòng
                                    ghi đúng STK, nội dung chuyển khoản, Số tiền
                                    (sai sẽ bị phạt 20%)
                                </li>
                            </ul>
                        </div>
                                ...
                                <div className="refill_main">
                                    ...
                                    <div className="refill_main_content">
                                        <div className="refill_main_item">
                                            <p>
                                                Số dư quỹ:{" "}
                                                <span className="text-success txt_bold">
                                            ...
                                            <div className="b1">
                                                <h6 className="txt_bold">
                                                    <Form.Check
                                                        type={"radio"}
                                                        label={
                                                            "Bước 1: Số tiền - Phương thức nạp"
                                                        }
                                                        checked={step > 1}
                                                        readOnly
                                                    />
                                                ...
                                                <div className="b2">
                                                    <h6 className="txt_bold">
                                                        <Form.Check
                                                            type={"radio"}
                                                            label={
                                                                "Bước 2: Chọn ngân hàng nạp tiền"
                                                            }
                                                            checked={step > 2}
                                                            readOnly
                                                        />
