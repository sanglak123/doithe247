...
import { Button, Col, Form, Row, Container, InputGroup, ButtonGroup, Table } from 'react-bootstrap';
...
function Profile(props) {
    ...
    const handleSendKeyAuthEmail = async () => {
        await UserAuthApi.SendKeyAuthEmail(accessToken, dispatch, keyActiveEmail)
    };
    ...
    const handleAddBank = async () => {
        await UserPaymentsApi.BankOfUser.Add(dispatch, accessToken, idBank, number, owner, branch, User?.id, AddBankOfUserSuccess);
        setIdBank("");
        setNumber("");
        setOwner("");
        setBranch("");
                                ...
                                edit === true ?
                                    <>
                                        <ButtonGroup className='btn_edit_profile'>
                                            <Button variant='success' onClick={() => setEdit(false)} >Save</Button>
                                    ...
                                    }} className='btn_edit_profile'>Edit</Button>
                            }

                            <div className='profile_User_content'>
                                <Container>
                                    <Row>
                                        <Col xs={12} sm={12} md={6} xl={6} xxl={4}>
                                            <div className='profile_User_item'>
                                                <Form.Group className="mb-3">
                                                    <Form.Label>Tên đăng nhập</Form.Label>
                                                    <Form.Control
                                                        className={edit === true ? "txt_block" : ""}
                                                        readOnly
                                                        value={User.userName}
                                                    />
                                                    {
                                                        edit === true &&
                                                        <Form.Text className='text-danger'>Thông tin cố định.</Form.Text>
                                                    }
                                                </Form.Group>
                                            </div>
                                        </Col>
                                            ...
                                            <div className='profile_User_item'>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <Form.Control
                                                        ...
                                                        value={edit === false ? User?.displayName ? User?.displayName : "" : displayName}
                                                ...
                                                <Form.Group className="mb-3">
                                                    {
                                                        User?.email?.split("$$")[1] === "active" ?
                                                            <>
                                                                ...
                                                                <Form.Text className='text-success'>Email đã được kích hoạt.</Form.Text>
                                                            </>
                                                            :
                                                            <>
                                                                {
                                                                        ...
                                                                        <>
                                                                            {
                                                                                active === true ?
                                                                                    <>
                                                                                        <Form.Label>Mã kích hoạt email</Form.Label>
                                                                                        <InputGroup>
                                                                                            <Form.Control
                                                                                                value={keyActiveEmail}
                                                                                                onChange={(e) => setKeyActiveEmail(e.target.value)}
                                            ...
                                            <div className='profile_User_item'>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <Form.Control
                                                        className={edit === true ? "txt_block" : ""}
                                                        readOnly
                                                        value={User?.wallet_number?.split(" ")[1]}
                                                    />
                                                    {
                                                        edit === true &&
                                                        <Form.Text className='text-danger'>Thông tin cố định.</Form.Text>
                                    ...
                                    <Row>
                                        <Col xs={12} sm={12} md={12} xl={6}>
                                            <div className='profile_User_item'>
                                                <Form.Group className="mb-3">
                                                    <Form.Label>Partner_Key</Form.Label>
                                                    <InputGroup>
                                                        <Form.Control
                                                            className="txt_block"
                                                            readOnly
                                                            value={User?.partner_key}
                                                        />
                                                        <Button onClick={() => navigator.clipboard.writeText(User?.partner_key)}>
                                                ...
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <InputGroup>
                                                        <Form.Control
                                                            className="txt_block"
                                                            readOnly
                                                            value={User?.api_key ? User?.api_key : "Chưa khởi tạo."}
                                                        />
                                        ...
                                        <Col xs={12} sm={12} md={12} xl={6}>
                                            <div className='profile_User_item'>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <Form.Control
                                                        readOnly={edit === false}
                                                        value={edit === true ? adress : User?.adress ? User?.adress : ""}
                                        ...
                                        <Col xs={12} sm={12} md={12} xl={6}>
                                            <div className='profile_User_item'>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <Form.Control
                                                        readOnly={edit === false}
                                                        value={edit === true ? phone : User?.phone ? User?.phone.split("$$")[0] : ""}
                                                ...
                                                BankOfUsers?.map((item, index) => {
                                                    return (
                                                        <tr key={index} className="txt_white txt_center">
                                                            <td>{index + 1}</td>
                                                            <td>{item.Bank?.name} - {item.Bank?.sign}</td>
                                                            <td>
                                                                {
                                                                    editBank === item.id ?
                                                                ...
                                                                <ButtonGroup>
                                                                    {
                                                                        editBank === item.id ?
                                                                            <>
                                                                                <Button onClick={() => setEditBank(item.id)} variant='success'>Lưu</Button>
                                                                                <Button onClick={() => setEditBank("")} variant='danger'>Hủy</Button>
                                                                            </>
                                                                            :
                                                                            <>
                                                                                <Button onClick={() => {
                                            ...
                                            <Form.Select onChange={(e) => setIdBank(e.target.value)}>
                                                <option value={""}>Chọn ngân hàng</option>
                                                {
                                                    Banks?.map((item, index) => {
                                                        return (
                                                            <option value={item.id} key={index}>{item.name} - {item.sign}</option>
                                                        )
                                                    })
                                                }
                                            </Form.Select>
                                        ...
                                        <Form.Group className="mb-3">
                                            ...
                                            <InputGroup>
                                                <Form.Control
                                                    ...
                                                    onChange={(e) => setBranch(e.target.value)}
                                                />
                                                <Button variant='outline-success' onClick={() => handleAddBank()}>Thêm</Button>
                                            </InputGroup>
                    ...
                    <div className='profile_left'>
                        ...
                        <div className='avatar'>
                            <div className='avatar_img'>
                                <img src={User?.Img?.path} alt={User?.userName} />
                            </div>
                        </div>

                        <hr />
                        <div className='profile_left_btn'>
                            <Button className={action === "pass" ? "btn_active" : ""} onClick={() => setAction("pass")}>Đổi mật khẩu</Button>
                            <Button className={action === "avatar" ? "btn_active" : ""} onClick={() => setAction("avatar")}>Đổi ảnh đại diện</Button>
                        </div>
                        {
                            action === "avatar" ?
                                ...
                                <div className='profile_left_action mt-4'>
                                    ...
                                    <div className='txt_right'>
                                        <Button disabled={newPass === "" || reNewPass === "" || pass === "" || newPass !== reNewPass} className='me-2 btn_success' variant="success">
                                            Thay đổi
                                        </Button>
                                        <Button className='ms-2 btn_cancle' onClick={() => setChange(false)} variant="danger" type="submit">
                                            Hủy
                                        </Button>
                                    </div>
                                </div>
