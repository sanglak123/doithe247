...
function CardsHot(props) {
    //Data
    const Prices = useSelector(DataSelector.Prices).filter(
        item => item.Card?.change === true
    )
    ...
    return (
        <div
            id="cards_hot"
            className="mt-3 animate__animated  animate__fadeInRight"
        >
