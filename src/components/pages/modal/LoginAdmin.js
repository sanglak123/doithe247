...
function ModalLoginAdmin({ show, setShow }) {
    ...
    const handleLoginAdmin = async () => {
        await AdminAutheApi.Login(accessToken, dispatch, User?.id, pass2, keyAdmin, router, LoginAdminSuccess)
        onhide();
    }
    return (
        <Modal
        ...
        >
            ...
            <Modal.Footer>
                ...
                <Button disabled={pass2 === "" || keyAdmin === ""} variant='primary' onClick={handleLoginAdmin}>Đăng nhập</Button>
            </Modal.Footer>
        </Modal>
    );
}
