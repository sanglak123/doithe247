...
function BuyCards(props) {
    ...
    useEffect(() => {
        for (let index = 0; index < Store.length; index++) {
            total +=
                (parseFloat(Store[index].Value?.name) -
                    (parseFloat(Store[index].Value?.name) *
                        parseFloat(Store[index].feesBuy)) /
                        100) *
                parseFloat(Store[index].count)
        }
        setTotalPrice(total)
    }, [Store])
            ...
            if (payment !== "") {
                if (Store.length > 0) {
                    ...
                    if (array[0] === "Bank") {
                        ...
                        if (
                            parseFloat(User?.surplus) - parseFloat(totalPrice) >
                            0
                        ) {
                            await UserCardsApi.BuyCarrd(
                                dispatch,
                                accessToken,
                                User?.partner_key,
                                User?.id,
    ...
    return (
        <>
            <div
                id="BuyCards"
                className="bgr_dark animate__animated animate__fadeIn"
            >
                                ...
                                <div className="usemanual">
                                    <p>
                                        <span className="txt_bold text-danger">
                                            Hướng dẫn cách nạp thẻ Viettel trả
                                            trước bằng thẻ cào:
                                        </span>
                                        <br />
                                        ...
                                        Bạn có thể tới các cửa hàng đại lí có
                                        cung cấp thẻ cào viettel, sau đó mua thẻ
                                        điện thoại giấy gồm có số seri, mã thẻ,
                                        và lớp tráng bạc. Hoặc nếu muốn nhanh
                                        chóng hơn bạn cũng có thể nạp thẻ
                                        viettel trả trước tại các website cung
                                        cấp dịch vụ hoặc mua thẻ bằng tin nhắn
                                        SMS.
                                        <br /> <br />
                                        <span className="txt_bold">
                                            Bước 2:{" "}
                                        </span>
                                        Cạo lớp bạc để lấy dãy số sau đó nhấn
                                        mã: *100*Mã số thẻ cào# và bấm phím Gọi
                                        Nhà mạng viettel còn cung cấp dịch vụ
                                        nạp tiền cho thuê bao trả trước khác
                                        bằng thẻ cào giấy, để nạp tiền viettel
                                        bạn cần nhấn *103*Số điện thoại nhận*Mã
                                        số thẻ cào# và bấm phím Gọi, phí nạp cho
                                        thuê bao khác là 1000đ/ lần sẽ bị trừ
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="item_center">
                                                            <div className="count">
                                                                <span
                                                                    class="material-symbols-outlined add_count"
                                                                    onClick={() =>
                                                                        handleAddCard(
                                                                            item
                                                                        )
                                                                ...
                                                                <span
                                                                    class="material-symbols-outlined sub_count"
                                                                    onClick={() =>
                                                                        handleSubtrackCard(
                                                                            item
                                                                        )
