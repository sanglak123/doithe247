    ...
    const handleCreateWithdraw = async () => {
        if (AccessToken) {
            if (AccessToken) {
                ...
                if (surplus > 0) {
                    await UserPaymentsApi.Withdraws.Create(
                        AccessToken,
                        dispatch,
                        User?.id,
                        amount,
                    ...
                    await UserPaymentsApi.Withdraws.GettAll(
                        AccessToken,
                        dispatch,
                        User?.id,
            ...
            {AccessToken ? (
                <div className="withdraw_content bgr_dark mt-2">
                    <div className="note_whithdraw">
                        ...
                        <ul>
                            <li>
                                - Rút tiền về ví MOMO Chỉ Xử Lý Cho Đơn Nhỏ Hơn
                                200.001đ Quá Sẽ Bị Hủy Đơn.
                            </li>
                            <li>
                                - Trạng Thái Đơn Chờ xử lý Là Đơn Chuyển Đang
                                Trong Quá Trình Xử Lý.
                            </li>
                            <li>
                                - Trạng Thái Đơn Chờ kiểm tra lại Là Đơn Chuyển
                                Tiền Thất Bại, Admin sẽ xử lý trong vòng 24h ,
                                có thể liên hệ Tại Đây để được xử lý nhanh hơn.
                            </li>
                            <li>
                                - Trạng Thái Đơn Hoàn Thành Là Đơn Đơn Chuyển
                                Tiền Thành Công.
                            </li>
                    ...
                    <div className="withdraw_item">
                                        ...
                                        <div className="create_withdraw_item">
                                            ...
                                            >
                                                ...
                                                <Form.Text className="text-danger">
                                                    Tối thiểu 10,000đ , Tối đa
                                                    100,000,000đ - Bỏ 3 số "0"
                                                    cuối cùng. Vd: Rút
                                                    1,000,000đ {"=>"} Nhập:
                                                    "1000"
                                                </Form.Text>
                                                    ...
                                                    {BankUser?.map(
                                                        (item, index) => {
                                                            return (
                                                                ...
                                                                >{`${item.Bank?.name} - ${item.Bank?.sign}/STK: ${item.number} - ${item.owner}`}</option>
                                                            )
                                                        }
                                                    )}
                                                </Form.Select>
                                    ...
                                    <div className="limit_content">
                                        <ListGroup horizontal>
                                            <div>
                                                ...
                                                <ListGroup.Item className="txt_bold text-danger">
                                                    Không hạn chế
                                                </ListGroup.Item>
                                            </div>
                                            <div>
                        ...
                        <div className="table_pending">
                            <div className="hearder_hag">
                                <h1>Lệnh Rút Đang Xử Lý</h1>
                            </div>
                            {WithdrawPending.length > 0 ? (
                                <div className="table_withdraw">
                                    <TableWithdraw Array={WithdrawPending} />
                                </div>
                            ) : (
                                <div className="table_withdraw">
                        ...
                        <div className="table_history">
                            ...
                            {WithdrawHistory.length > 0 ? (
                                <div className="table_withdraw">
                                    <TableWithdraw Array={WithdrawHistory} />
                                </div>
                            ) : (
                                <div className="table_withdraw">
                                    <p className="text-danger">
