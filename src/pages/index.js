...
function MainApp(props) {
    ...
    useEffect(() => {
        if (with_window < 1220) setShowMenu(false)
    }, [with_window])
    ...
    return (
        <div id="main_app">
            <div
                className={
                    showMenu
                        ? "left_sidenav animate__animated animate__backInLeft"
                        : "left_sidenav menu_short animate__animated animate__backInLeft"
                }
            >
                            ...
                            <div className="menu_main">
                                <div className="menu_items">
                                    ...
                                    <div
                                        ...
                                        onClick={() => setView("Nạp tiền")}
                                    >
                                        <p className="m-0">
                                            Nạp tiền<Badge bg="danger">9</Badge>
                                        </p>
                                        <div className="menu_icon">
                                    ...
                                    <div
                                        ...
                                        onClick={() => setView("Rút tiền")}
                                    >
                                        <p className="m-0">
                                            Rút tiền<Badge bg="danger">1</Badge>
                                        </p>
                                        <div className="menu_icon">
                                            <span className="material-symbols-outlined">
                                                payments
                        ...
                        {accessToken ? (
                            <div className="user_info">
                                ...
                                <div className="user_item ms-2">
                                    ...
                                    <span>{formatMoney(User?.surplus)}</span>
                                </div>
                            </div>
                        ) : (
                            <div className="user_info">
            ...
            <ModalRegister show={Register} setShow={setRegister} />
