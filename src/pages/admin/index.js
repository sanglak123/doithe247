...
function AdminLogin(props) {
    ...
    const handleLoginAdmin = async () => {
        await AdminAutheApi.Login(userName, pass, pass2, keyAdmin, dispatch, LoginSuccess, router)
    };
            ...
            <div className='login_content'>
                <div className='login_main'>
                    ...
                    <div className='login_footer'>
                        <Link className='btn btn-danger btn_login' href={"/"}>Cancle</Link>
                        <Button className='btn_login' onClick={() => handleLoginAdmin()}>Đăng nhập</Button>
                    </div>
                </div>
