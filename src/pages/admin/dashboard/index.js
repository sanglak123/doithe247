...
import MessageAdmin from "@/components/dashboard/Message";
...
function DashboardAdmin(props) {
    ...
    const handleRenderViews = () => {
        switch (view) {
            case "Message": return <MessageAdmin />

            case "Khách hàng": return <DashboardUsers accessToken={accessToken} />

            case "Chiết khấu": return <Prices accessToken={accessToken} />

            case "Loại thẻ": return <AdminCards accessToken={accessToken} />

            case "Lệnh nạp": return <AdminListRefills accessToken={accessToken} />

            case "Lệnh rút": return <AdminListWithdraws accessToken={accessToken} />

            case "Hổ trợ": return <AdminMessage accessToken={accessToken} />

            case "Message": return <ChatBox accessToken={accessToken} />

            case "Thông tin tài khoản": return <Profile accessToken={accessToken} />

            default: return <DashboardSystems accessToken={accessToken} />
        }
    };
                            ...
                            <div className="menu_content">
                                ...
                                <div className='menu_main'>
                                    ...
                                    <div className="menu_items">
                                        ...
                                        <div className={view === "Chiết khấu" ? "menu_item menu_active" : "menu_item"} onClick={() => setView("Chiết khấu")}>
                                        ...
                                        <div className={view === "Lệnh rút" ? "menu_item menu_active" : "menu_item"} onClick={() => setView("Lệnh rút")}>
                                            <p className='m-0'>Lệnh rút<Badge bg="danger">1</Badge></p>
                                            <div className='menu_icon'>
                                                <span className="material-symbols-outlined">
                                                    payments
                                                </span>
                                        ...
                                        <div className={view === "Lệnh nạp" ? "menu_item menu_active" : "menu_item"} onClick={() => setView("Lệnh nạp")}>
                                            <p className='m-0'>Lệnh nạp<Badge bg="danger">1</Badge></p>
                                            <div className='menu_icon'>
                                                <span className="material-symbols-outlined">
                                                    payments
                                                </span>
                                        ...
                                        <div className={view === "Hổ trợ" ? "menu_item menu_active" : "menu_item"} onClick={() => setView("Hổ trợ")}>
                                            <p className='m-0'>Hổ trợ<Badge bg="danger">1</Badge></p>
                                            <div className='menu_icon'>
                                                <span className="material-symbols-outlined">
                                                    payments
                                                </span>
